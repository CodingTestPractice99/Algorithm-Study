...
public class _5_LongestPalindromicSubstring {
    ...
    public void extendPalindrome(String s, int j, int k) {
        // 투 포안터가 유효한 범위 내에 있고 양쪽 끝 문자가 일치하는 팰린드롬인 경우 범위 확장
    ...
    public static void main(String[] args) {
        _5_LongestPalindromicSubstring n = new _5_LongestPalindromicSubstring();
        System.out.println(n.longestPalindrome("dcbabcdd"));
        _5_LongestPalindromicSubstring m = new _5_LongestPalindromicSubstring();
